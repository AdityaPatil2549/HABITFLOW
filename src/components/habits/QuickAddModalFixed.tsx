  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-[512px] mx-4 bg-slate-900/90 backdrop-blur-2xl border border-white/10 shadow-2xl shadow-black/80 rounded-[32px] overflow-hidden"
      >

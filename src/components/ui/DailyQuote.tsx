...
const QUOTES = [
  ...
  { text: "One percent better each day compounds to being 37 times better in a year.", author: "James Clear" },
  ...
  { text: "We become what we want to be by consistently being what we want to become.", author: "Richard G. Scott" },

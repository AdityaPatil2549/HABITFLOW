            ...
            <div className="grid grid-cols-5 gap-1">
              {(
                [
                  {
                    score: 1,
                    emojiUrl: 'https://fonts.gstatic.com/s/e/notoemoji/latest/1f61e/512.webp',
                    label: 'Rough',
                    color: '#f43f5e',
                  },
                  {
                    score: 2,
                    emojiUrl: 'https://fonts.gstatic.com/s/e/notoemoji/latest/1f615/512.webp',
                    label: 'Meh',
                    color: '#fb923c',
                  },
                  {
                    score: 3,
                    emojiUrl: 'https://fonts.gstatic.com/s/e/notoemoji/latest/1f610/512.webp',
                    label: 'Okay',
                    color: '#facc15',
                  },
                  {
                    score: 4,
                    emojiUrl: 'https://fonts.gstatic.com/s/e/notoemoji/latest/1f60a/512.webp',
                    label: 'Good',
                    color: '#4ade80',
                  },
                  {
                    score: 5,
                    emojiUrl: 'https://fonts.gstatic.com/s/e/notoemoji/latest/1f604/512.webp',
                    label: 'Great',
                    color: '#10b981',
                  },
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        ...
                        style={isSelected ? { filter: `drop-shadow(0 0 16px ${color}80)` } : {}}
                      />
                    </div>
                    <span
                      className={cn(

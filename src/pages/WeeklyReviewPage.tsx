  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <motion.h1
        ...
        className="text-3xl sm:text-4xl font-black text-white text-center tracking-tight px-4"
      >
        {headline}
      </motion.h1>
      <p className="text-slate-400 text-sm italic opacity-75 text-center">"Your habits determine your future."</p>
    </div>
  );
}
  ...
  return (
    <TiltCard className="h-full">
      <motion.div
        ...
        className="h-full rounded-2xl p-6 relative overflow-hidden group border border-white/8 backdrop-blur-xl"
      ...
      >
        ...
        <p className="text-5xl font-black text-white tracking-tighter mb-1 relative z-10">
          {counted}{suffix}
        </p>
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-base font-black text-white">30-Day Completion Rates</h2>
        <button
          onClick={toggleAll}
        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              !h.isBest && !h.isStruggling && 'border-white/8 bg-white/3',
            )}
            ...
            <div className="flex items-center gap-3">
              ...
              <TiltCard className="flex-shrink-0">
                ...
                >
                  ...
                  >
                    {ICON_MAP[h.icon?.toLowerCase()] || h.icon || '⚡'}
                  </span>
                </div>
              </TiltCard>
...
function MoodReflection() {
  ...
  function handleSave() {
    try { localStorage.setItem(STORAGE_KEY, JSON.stringify({ mood, intention })); }
    catch { /* ignore */ }
    setSaved(true);
    fireConfetti();
        ...
        <div className="grid grid-cols-3 gap-3">
          {MOODS.map(m => (
            ...
            >
              ...
              <span className="text-xs font-black text-white relative z-10">{m.label}</span>
...
export function WeeklyReviewPage() {
  ...
  useEffect(() => {
    ...
    import('../db').then(({ db }) => {
      db.habitLogs
        ...
        .toArray()
        .then(logs => setWeeklyHabitsDone(new Set(logs.map(l => l.habitId)).size))
  ...
  const score        = activeHabits.length ? Math.min(100, Math.round((weeklyHabitsDone / activeHabits.length) * 100)) : 0;
  ...
  // ── Render ──────────────────────────────────────────────────────
  return (
    <div className="max-w-3xl mx-auto px-4 pb-28 pt-4 relative min-h-screen">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="rounded-2xl border border-white/8 p-5 sm:p-6 relative overflow-hidden"
            style={{ background: 'rgba(255,255,255,0.025)', backdropFilter: 'blur(20px)' }}
          >
            ...
            <div className="flex items-center gap-2 mb-5 relative z-10">
              ...
              <h2 className="text-base font-black text-white">Weekly Reflection</h2>
            </div>

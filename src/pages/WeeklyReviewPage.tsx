  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pb-24 pt-8 relative min-h-[90vh]">
      ...
      <div className="text-center relative mb-10 z-10">
        ...
        <p className="whitespace-nowrap text-slate-400 text-sm sm:text-base font-medium leading-relaxed italic opacity-80 mt-2">"Your habits determine your future."</p>
      </div>

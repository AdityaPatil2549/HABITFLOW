        ...
        {filtered.map((item, idx) => {
          ...
          return (
            <motion.div
              ...
              className={`h-full ${item.category === 'theme' ? 'col-span-2' : 'col-span-1'}`}
            >
              <TiltCard tiltIntensity={item.category === 'theme' ? 5 : 12} className="h-full block">
                <div className={`relative h-full rounded-2xl border ${rarity.border} overflow-hidden group bg-white dark:bg-slate-900 shadow-sm transition-[transform,box-shadow,border-color,background-color] duration-300 ease-out hover:border-brand-500/30 ${rarity.glow ? `shadow-lg ${rarity.glow}` : ''}`}>
                  {/* Legendary shimmer */}
                  ...
                  <div className="relative p-4 flex flex-col items-center text-center">
                    ...
                    {/* Icon */}
                    <div className={`text-4xl mb-3 group-hover:scale-[1.08] transition-transform duration-300 ease-out ${item.category === 'theme' ? 'text-5xl' : ''}`}>
                      {item.icon}
                    </div>
                    ...
                    {owned ? (
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-[transform,background-color,box-shadow] duration-200 ease-out active:scale-[0.97] ${
                          canAfford
